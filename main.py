...
try:
    os.makedirs('{}/cluwords/{}'.format(MAIN_PATH, EMBEDDING_RESULTS))
    os.makedirs('{}/cluwords/{}/results'.format(MAIN_PATH, EMBEDDING_RESULTS))
    os.makedirs('{}/cluwords/{}/datasets'.format(MAIN_PATH, EMBEDDING_RESULTS))
    os.makedirs('{}/cluwords/{}/datasets/gn_w2v_models'.format(MAIN_PATH, EMBEDDING_RESULTS))
